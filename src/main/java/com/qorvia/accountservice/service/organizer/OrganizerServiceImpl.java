...
import com.qorvia.accountservice.client.PaymentRabbitMqClient;
...
public class OrganizerServiceImpl implements OrganizerService {
    ...
    private final PaymentRabbitMqClient paymentRabbitMqClient;
    ...
    @Override
    public String createAccountOnboardingLink(Long organizerId) throws IOException {
        Optional<Organizer> organizer = organizerRepository.findById(organizerId);
        ...
        StripeAccountOnboardingRequestMessageResponse response = paymentRabbitMqClient.generateAccountLinkForOnboarding(organizerId, organizer.get().getEmail());
        ...
        if (response != null) {
            ...
            throw new RuntimeException("Failed to generate account onboarding link");
        }
    }
